...
float4 Fragment(Interpolators input) : SV_TARGET{
	float2 uv = input.uv;
	float4 colorSample = SAMPLE_TEXTURE2D(_BaseMap, sampler_BaseMap, input.positionWS.xz) * _BaseColor;
	...
	return SpookyLighting(surfaceInput, lightingInput);
